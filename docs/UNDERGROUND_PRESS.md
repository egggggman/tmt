...
- Headlines state the important truth without exaggeration.
- News copy separates observation from interpretation and attributes material claims.
- Sources are named when safe; anonymous sourcing requires a clear reason and editorial care.
- Rumors are not printed as facts. If newsworthy, label uncertainty and explain verification limits.
- Opinion is visibly labeled and does not rewrite reported facts.
- Corrections are prompt, specific, visible, and preserved with the record.
