...
bounded Prototype 0.2 candidates, and Cardcade evidence are pending in draft PR #15. Cardcade Engine
0.6 currently fails its stability gate, so its findings remain hypotheses and Prototype 0.3 is not
authorized. See [Project State](PROJECT_STATE.md), [HQ](docs/HQ.md), and the
