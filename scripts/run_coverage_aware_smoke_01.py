"""Plan or explicitly execute Coverage-Aware Engine Smoke Stage 0.1."""
...
from tmnt_design_studio.smoke01 import execute_smoke, plan
...
def main() -> None:
    ...
    if args.execute:
        ...
        execute_smoke(root, output=args.output, failure_output=args.failure_output)
        return
